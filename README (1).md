# 🛰️ BharatDrishti — AI-Powered Digital Twin of India
...
| Feature | Description |
|---------|-------------|
| 🗺️ **3D Mapbox GL map** | Interactive globe with India overlay |
| 🌡️ **State-wise temperature** | Hover any state → climate data popup |
| 🌧️ **Rainfall layer** | Spatial rainfall visualization |
...
| 🕰️ **Temporal analysis** | Historical (2000–2023) + Live + AI Forecast |
...
*BharatDrishti — Seeing India Through AI Eyes* 🛰️
